...
Answer: Preprocessor like LESS is a tool to write clearer CSS. LESS allows developer to select elements by following the html's hierarchy structure. Less also enable developers to Use variables and functions. LESS compiler is use to compile LESS codes to CSS codes.

2. What is your favorite concept in preprocessing? What is the concept that gives you the most trouble?
 
Answer: I like the concept of using variables.  I am slow in using mixins yet but I also like the concept as it has the potential of making codes "DRY"

3. How would you explain the concept of a variable to someone new to programming?

Answer: variable is a handle of data in the computer's memory.  You can access a particular data by using its handle or variable's name.

4. What is the purpose of using functions in code?

Answer: A function is a set of codes that can accomplish a certain tasks.  You can run these set of codes by running or calling the function.  Function is very helpul to make the code "DRY".

5. What is a JSON data?

Answer: Jason data is composed of name and value pairs. The syntax is {name:value, name2:value2}.
